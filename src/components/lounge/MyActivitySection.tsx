...
import myCommentsIcon from '@/assets/lounge/my-comments.png';
import savedPostsIcon from '@/assets/lounge/saved-posts.png';
import scrapsIcon from '@/assets/lounge/scraps.png';
