    ...
    <header className="shrink-0 bg-white">
      <div className="px-5 pt-2 flex justify-between items-center">
        <div className="flex items-center gap-2.5">
          <h1 className="text-slate-900 typo-heading-3xl leading-10">
            My Page
          </h1>
          {isArtistVerified && isArtistView && (
            <span className="px-1.5 py-0.5 bg-blue-100 rounded-sm">
              <span className="text-blue-600 typo-body-xs-regular leading-3">
                작가인증
              </span>
            </span>
          )}
      ...
      <div className="px-5 pt-5 pb-5 flex flex-col gap-3.5">
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-1.5">
            <div className="text-neutral-900 typo-body-xl-bold leading-7 truncate">
              {profile.name}
            </div>
            {isArtistView ? (
              <div className="flex items-center gap-5.5">
                <div className="w-17.5 flex flex-col items-center gap-0.5">
                  <img
                    ...
                    alt=""
                  />
                  <span className="text-neutral-900 typo-body-xs-semibold leading-4">
                    {profile.school}
                  </span>
                </div>
              ...
              <div className="text-slate-950 typo-body-xs-regular leading-4 truncate">
          ...
          {!isArtistVerified && !isArtistView && (
            ...
            >
              <span className="text-neutral-900 typo-body-xs-regular underline leading-4">
                작가 인증하기
              </span>
            </button>
          )}
        ...
        {isArtistView && profile.bio && (
          <div className="flex flex-col gap-2">
            <p className="text-neutral-800 typo-body-xs-semibold leading-4">
              {profile.bio}
            </p>
        ...
        {isArtistView && (
          <div className="flex items-center gap-3">
            ...
            >
              <span className="text-neutral-900 typo-body-md-regular">
                전시/작품등록
              </span>
            </button>
            <button
