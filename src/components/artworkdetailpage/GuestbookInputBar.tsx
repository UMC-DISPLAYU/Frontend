...
export function GuestbookInputBar({
  ...
  return (
    <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-page border-t border-line px-5 py-3 shadow-[0px_-4px_18px_0px_rgba(67,0,209,0.06)] z-50">
      <form
        onSubmit={handleSubmit}
        className="w-full h-11 px-3.5 bg-box200 rounded-xl flex items-center justify-between gap-2"
      >
