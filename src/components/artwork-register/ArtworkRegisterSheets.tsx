...
interface ArtworkRegisterSheetsProps {
  ...
  onClose: () => void;
  onOpenProxyTeamAuthor: () => void;
  onOpenProxyDirectAuthor: () => void;
...
function ArtworkRegisterSheets({
  ...
  onClose,
  onOpenProxyTeamAuthor,
  onOpenProxyDirectAuthor,
