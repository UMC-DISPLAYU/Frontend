...
export function FilterChip({ label, onClick, selected }: FilterChipProps) {
  return (
    <button
      className={`flex shrink-0 items-center justify-center gap-2.5 rounded-sm px-2.5 py-1.5 whitespace-nowrap shadow-[4px_4px_12px_0px_rgba(67,0,209,0.05)] outline outline-1 -outline-offset-1 ${
        selected
